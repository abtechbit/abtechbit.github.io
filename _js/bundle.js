...
},{"./journal.js":9,"big.js":3,"underscore":5}],8:[function(require,module,exports){
var Big = require('big.js');
...
},{"big.js":3}],9:[function(require,module,exports){
var Big = require('big.js');
var _ = require('underscore');
...
},{"./expression-evaluator.js":8,"big.js":3,"underscore":5}],10:[function(require,module,exports){
...
},{"moo":4}],11:[function(require,module,exports){
...
},{"../resources/ledger-cli":13}],12:[function(require,module,exports){
var LedgerParser = {
...
},{"./chunk-parser.js":10,"./grammar-parser":11}],13:[function(require,module,exports){
/*
...
function peg$parse(input, options) {
  ...
  var peg$FAILED = {},
      ...
      peg$startRuleFunctions = { journalEntry: peg$parsejournalEntry },
      peg$startRuleFunction  = peg$parsejournalEntry,

      peg$c0 = function(e) {return e},
      peg$c1 = function(t) { return t },
      peg$c2 = function(c) {return c; },
      peg$c3 = function(c) {return {type: 'comment'}; },
      peg$c4 = "bucket",
      peg$c5 = peg$literalExpectation("bucket", false),
      peg$c6 = function(account) { return {type: "bucket", account:account}},
      peg$c7 = "include",
      peg$c8 = peg$literalExpectation("include", false),
      peg$c9 = function() { return {type: "include"}},
      peg$c10 = "year",
      peg$c11 = peg$literalExpectation("year", false),
      peg$c12 = function(year) { return {type: "year", year:year}},
      peg$c13 = function(date, status, payee, note, posting) {
            var txn = {
              type: 'transaction',
              date: date,
              payee: payee,
      ...
      peg$c16 = function(year, month, day) { return {year:year, month:month, day: day}; },
      peg$c17 = /^[0-9]/,
      ...
      peg$c32 = function(comment) { return comment; },
      peg$c33 = function(account, amount, note) {
      ...
      peg$c34 = function(comment) { return {type: 'comment', text: comment }; },
      peg$c35 = "#",
      peg$c36 = peg$literalExpectation("#", false),
      peg$c37 = function(s, a) {
          var amount = a;
          amount.assignment = s;
          return amount;
        },
      peg$c38 = function(s) {return s != undefined},
      peg$c39 = "=",
      ...
      peg$c45 = function(currency, amount) {return {currency:currency, amount:amount};},
      peg$c46 = function(expression) {return {amount:expression};},
      ...
      peg$c72 = function(operator, argument) {
            return {
      ...
      peg$c77 = function(head, tail) { return buildBinaryExpression(head, tail); },
      peg$c78 = "%",
      ...
      peg$c84 = function() { return parseFloat(text().replace(/,/g, '')); },
      peg$c85 = ".",
  ...
  function peg$parsejournalEntry() {
    var s0, s1, s2;
  ...
  function peg$parsetransactionNote() {
    var s0, s1, s2;

    s0 = peg$currPos;
    s1 = [];
    s2 = peg$parsehardSeparator();
    if (s2 !== peg$FAILED) {
      while (s2 !== peg$FAILED) {
        s1.push(s2);
        s2 = peg$parsehardSeparator();
  ...
  function peg$parseposting() {
    var s0, s1, s2, s3, s4, s5, s6;

    s0 = peg$currPos;
    s1 = peg$parsepostingPrefix();
    if (s1 !== peg$FAILED) {
      s2 = peg$currPos;
      peg$silentFails++;
      s3 = peg$parsemainCommentPrefix();
      peg$silentFails--;
      if (s3 === peg$FAILED) {
        s2 = void 0;
      } else {
      ...
      if (s2 !== peg$FAILED) {
        s3 = peg$parseaccount();
        if (s3 !== peg$FAILED) {
          s4 = peg$parsepostingAmount();
          if (s4 === peg$FAILED) {
            s4 = null;
          }
          if (s4 !== peg$FAILED) {
            s5 = peg$parsepostingNote();
            if (s5 === peg$FAILED) {
              s5 = null;
            }
            if (s5 !== peg$FAILED) {
  ...
  function peg$parsepostingPrefix() {
    var s0, s1, s2;
  ...
  function peg$parsepostingAmount() {
    var s0, s1, s2, s3;

    s0 = peg$currPos;
    s1 = peg$parseaccountAmountSep();
    if (s1 !== peg$FAILED) {
      s2 = peg$parsepostingAssignment();
      if (s2 !== peg$FAILED) {
        s3 = peg$parseamount();
        if (s3 !== peg$FAILED) {
          peg$savedPos = s0;
  ...
  function peg$parsepostingAssignment() {
    var s0, s1, s2, s3;
  ...
  function peg$parsemainCommentPrefix() {
    var s0;
  ...
  function peg$parseaccount() {
    ...
    s0 = [];
    s1 = peg$parseaccountLevelWithSeparator();
    if (s1 !== peg$FAILED) {
      while (s1 !== peg$FAILED) {
        s0.push(s1);
        s1 = peg$parseaccountLevelWithSeparator();
  ...
  function peg$parseaccountLevelWithSeparator() {
    var s0, s1, s2;

    s0 = peg$currPos;
    s1 = peg$parseaccountLevel();
    if (s1 !== peg$FAILED) {
      s2 = peg$parseaccountLevelSep();
      if (s2 !== peg$FAILED) {
        peg$savedPos = s0;
        s1 = peg$c47(s1);
        s0 = s1;
  ...
  function peg$parseaccountAmountSep() {
    var s0, s1, s2, s3;
  ...
  function peg$parseaccountLevelSep() {
    var s0;
  ...
  function peg$parseaccountLevel() {
    var s0, s1, s2, s3, s4, s5, s6;
  ...
  function peg$parsehardSeparator() {
    var s0, s1, s2, s3;
  ...
  function peg$parseAmountLiteral() {
    var s0, s1, s2;
...
},{"vue":6}],15:[function(require,module,exports){
var Vue = require('vue');
...
},{"../../generator/generator.util":2,"../../src/balance":7,"../../src/journal":9,"../../src/parser/journal-parser":12,"./components/account-filter.js":14,"./components/accounts.js":15,"./util/account-name-helper":17,"big.js":3,"vue":6}],17:[function(require,module,exports){
module.exports = {
